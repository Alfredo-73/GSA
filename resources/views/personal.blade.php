        ...
        <div class="">
            <div class="px-4">
                <div class="table-wrapper">
                    <h1 class="text-center mb-5" style="font-family:Verdana, Geneva, Tahoma, sans-serif">PERSONAL</h1>
                ...
                <div class="container-fluid">
                    <nav class="navbar  navbar-dark indigo rounded mb-2">
                        ...
                        <form class="form-inline">
                            ...
                            <a href="{{ url('/personal') }}" title="Refrescar" name="Refrescar" style="color:white; font-family:Verdana, Geneva, Tahoma, sans-serif"><i class="fas fa-sync-alt ml-1" style="color:white"></i>Refrescar</a>
