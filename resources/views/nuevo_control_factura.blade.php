            ...
            <form method="POST" action="{{ url('/nuevo_control_factura') }}" onsubmit="return validar_control(this)" name="formulario" id="formulario">
                    ...
                    <table id="tblfact" summary="" role="" cellpadding="4" cellspacing="1" class="form-matrix-table" data-component="matrix">
                        ...
                        <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_7 label_7_row_0">
                            ...
                            <td class="form-matrix-values">
                                <select class="form-dropdown" id="id_cliente" name="id_cliente[]" style="width:120px" data-component="dropdown" value="{{ old('$cliente->nombre') }}" required="" aria-labelledby="label_3">
                            ...
                            <td class="form-matrix-values">
                                <select class="form-dropdown" id="id_empresa" name="id_empresa[]" style="width:120px" data-component="dropdown" value="{{ old('$empresa->razon_social') }}" required="" aria-labelledby="label_3">
                            ...
                            <td class="form-matrix-values">
                                <input type="decimal" id="importe" class="form-textbox" size="15" name="importe[]" style="width:100%;box-sizing:border-box" value="{{ old('importe') }}" aria-labelledby="label_7_col_2">
                            </td>
                            <td class="form-matrix-values">
                                <input type="double" id="iva" class="form-textbox" size="15" name="iva[]" style="width:100%;box-sizing:border-box" value="{{ old('iva') }}" aria-labelledby="label_7_col_2">
                            </td>
                            <td class="form-matrix-values">
                                <input type="double" id="orden_de_pago" class="form-textbox" size="15" name="orden_de_pago[]" style="width:100%;box-sizing:border-box" value="{{ old('orden_pago') }}" aria-labelledby="label_7_col_2">
                            </td>
                        </tr>
                    </table>
                    ...
                    <table id="tblfact1" summary="" role="presentation" cellpadding="4" cellspacing="0" class="form-matrix-table" data-component="matrix">
                        <tbody>
                            ...
                            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_7 label_7_row_0">
                                ...
                                <td class="form-matrix-values">1</td>
                                <td class="form-matrix-values">
                                    <input type="double" id="anticipo" class="form-textbox" size="20" name="anticipo[]" style="width:100%;box-sizing:border-box" value="{{ old('nueve_treintayuno') }}" aria-labelledby="label_7_col_5">
                                </td>
                                <td class="form-matrix-values">
                                    <input type="double" id="saldo" class="form-textbox" size="20" name="saldo[]" style="width:100%;box-sizing:border-box" value="{{ old('importe_a_pagar') }}" aria-labelledby="label_7_col_6">
                                </td>
                                <td class="form-matrix-values">
                                ...
                                <td class="form-matrix-values">
                                    <input type="double" id="pago_personal" class="form-textbox" size="20" name="importe_a_pagar[]" style="width:100%;box-sizing:border-box" value="{{ old('pago_personal') }}" aria-labelledby="label_7_col_4">
                                </td>
                                <td class="form-matrix-values">
                                ...
                                <td class="form-matrix-values">
                                    <input type="double" id="importe_a_pagar" class="form-textbox" size="20" name="pago_personal[]" style="width:100%;box-sizing:border-box" value="{{ old('importe_a_pagar') }}" aria-labelledby="label_7_col_6">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table id="tblfact2" summary="" role="presentation" cellpadding="4" cellspacing="0" class="form-matrix-table" data-component="matrix">
                        <tbody>
                            ...
                            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_7 label_7_row_0">
                                ...
                                <td class="form-matrix-values">
                                    <input type="double" id="importe_cosecheros" class="form-textbox" size="20" name="importe_cosecheros[]" style="width:100%;box-sizing:border-box" value="{{ old('cantidad_cosecheros') }}" aria-labelledby="label_7_col_2">
                                </td>
                                <td class="form-matrix-values">
                    ...
                    <table id="tblfact3" summary="" role="presentation" cellpadding="4" cellspacing="0" class="form-matrix-table" data-component="matrix">
                        <tbody>
                            ...
                            <tr class="form-matrix-tr form-matrix-value-tr" role="group" aria-labelledby="label_7 label_7_row_0">
                                ...
                                <td class="form-matrix-values">
                                    <input type="double" id="toneladas" class="form-textbox" size="15" name="toneladas[]" style="width:100%;box-sizing:border-box" value="{{ old('cantidad_bines') }}" aria-labelledby="label_7_col_1">
                                </td>
                                <td class="form-matrix-values">
                ...
                <li class="form-line" data-type="control_textarea" id="id_14">
                    ...
                    <div id="cid_14" class="form-input">
                        <textarea id="observaciones" class="form-textarea" name="observacion" cols="40" rows="6" data-component="textarea" aria-labelledby="label_14"></textarea>
                    </div>
                </li>
                ...
                <div class="row justify-content-center mt-1">
                    ...
                    <div>
                        ...
                        <a class="btn btn-primary" href="{{ ('resumen_control') }}"> Regresar</a>
                    </div>
                </div>
            </form>
    </div>
