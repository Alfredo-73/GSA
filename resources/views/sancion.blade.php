...
<div class="row container-fluid col-md-10 col-lg-10" id="contenido">
    <h1 class="mx-auto mb-5 mt-5" style="font-family:Verdana, Geneva, Tahoma, sans-serif">LISTADO DE SANCIONES</h1>
    ...
    <div class="container-fluid">
        <nav class="navbar  navbar-dark indigo rounded mb-2">
            <div>
                <span style="font-size:15px; font-family:Verdana, Geneva, Tahoma, sans-serif" class="text-white">INGRESE RANGO DE FECHA Y/O EMPLEADO:</span>
            </div>
            <form class="form-inline">
                ...
                <input name="buscarpornombre" class="form-control" type="search" placeholder="Buscar por nombre" aria-label="Search">
                <input name="buscarporapellido" class="form-control" type="search" placeholder="Buscar por apellido" aria-label="Search">
