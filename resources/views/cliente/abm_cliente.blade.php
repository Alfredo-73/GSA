            ...
            <div class="mx-auto">
                <div class="px-4">
                    <div class="table-wrapper">
                        ...
                        <a id="agregar" class="btn primary-color-dark mb-5 rounded" href="{{ route('/cliente/nuevo_cliente') }}" role="button" style="margin-left:35rem;color:white"><i class="fas fa-2x fa-plus mr-2" style="color:white"></i>NUEVO </a>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark indigo mb-4">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <form class="form-inline ml-auto">
                                ...
                                <a href="{{ route('cliente.listado') }}" title="Refrescar" name="Refrescar" style="color:white; font-family:Verdana, Geneva, Tahoma, sans-serif"><i class="fas fa-sync-alt ml-1" style="color:white"></i>Refrescar</a>
                            </form>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form method="POST" action="{{ route('cliente.borrar'.$cliente->id) }}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                ...
                                <td class="text-center">
                                    <a id="modificar" class="btn btn-primary btn-rounded mb-1 btn-sm text-center" href="{{ route('cliente.edit',$cliente->id)}}" role="button"><i class="fas fa-edit mr-2" style="color:white"></i>Modificar </a>
