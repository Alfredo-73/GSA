    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('cliente.agregar_cliente') }}" name="tuformulario">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                              <!--   <input type="button" onclick="pregunta()" value="Enviar"> -->
                                ...
                                <a class="fas fa-undo" role="button" href=  {{ route('cliente.agregar_cliente') }} style='margin-left:5rem' style="cursor:pointer",name="Regresar" >  Regresar</a>
