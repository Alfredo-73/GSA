                        ...
                        <form method="POST" action="{{ route('cliente.update',$cliente->id) }}">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a class="fas fa-undo" role="button" href={{ route('cliente.listado') }} style='margin-left:5rem' style="cursor:pointer" name="Regresar" title="Volver al listado">Regresar</a>
