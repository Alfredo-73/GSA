        ...
        <div class="modal-content">
            ...
            <div class="modal-body " style="margin-left:3rem">
                <div class="row">
                        ...
                        <input  style="width:7rem" type="text"  class="form-control" value="@if(!empty($empleado->empresa)) {{$empleado->empresa->razon_social}} @endif">
                        ...
                        <input  style="width:5rem" type="text" class="form-control" value="@if(!empty($empleado->legajo)) {{$empleado->legajo}} @endif">
                        ...
                        <input  style="width:5rem" type="text" class="form-control" value="@if(!empty($empleado)) {{$empleado->nombre}} @endif">
                        <label data-error="wrong" data-success="right" for="orangeForm-pass" style="color:blue">NOMBRE </label>
                        </div>

                        <div class="md-form mb-1" style="width:50%">
                        <i class="fas fa-dollar-sign prefix" style="color:darkblue"></i>
                        <input  style="width:5rem" type="text" class="form-control" value="@if(!empty($empleado)){{$empleado->apellido}} @endif">
                        <label data-error="wrong" data-success="right" for="orangeForm-pass" style="color:blue">APELLIDO  </label>
                        </div>

                        <div class="md-form mb-1" style="width:50%">
                        <i class="fas fa-dollar-sign prefix" style="color:darkblue"></i>
                        <input  style="width:5rem" type="text" class="form-control" value="@if(!empty($empleado)) {{$empleado->dni}} @endif">
                        ...
                        <input  style="width:5rem" type="text" class="form-control" value="@if(!empty($empleado)){{$empleado->cuil}} @endif">
                        <label data-error="wrong" data-success="right" for="orangeForm-pass" style="color:blue">CUIL   </label>
                        </div>

                        <div class="md-form mb-1" style="width:50%">
                        <i class="fas fa-dollar-sign prefixapp prefix" style="color:darkblue"></i>
                        <input  style="width:5rem" type="text" class="form-control" value="@if(!empty($empleado)) {{$empleado->fecha_ingreso}} @endif">
                        <label data-error="wrong" data-success="right" for="orangeForm-pass" style="color:blue">FECHA INGRESO </label>
                        </div>
                        <div class="md-form mb-1" style="width:50%">
                        <i class="fas fa-dollar-sign prefixapp prefix" style="color:darkblue"></i>
                        <input  style="width:5rem" type="text" class="form-control" value="@if(!empty($empleado)){{$empleado->fecha_egreso}} @endif">
                        <label data-error="wrong" data-success="right" for="orangeForm-pass" style="color:blue">FECHA EGRESO   </label>
                        </div>
                        <div class="md-form mb-1" style="width:50%">
                        <i class="fas fa-dollar-sign prefixapp prefix" style="color:darkblue"></i>
                        <input  style="width:5rem" type="text" class="form-control" value="@if(!empty($empleado->capataz))  {{$empleado->capataz->nombre}} @endif">
                        <label data-error="wrong" data-success="right" for="orangeForm-pass" style="color:blue">CAPATAZ </label>
                        </div>
                        <div class="md-form mb-1" style="width:50%">
                        <i class="fas fa-dollar-sign prefixapp prefix" style="color:darkblue"></i>
                        <input  style="width:5rem" type="text" class="form-control" value="@if(!empty($empleado->sanciones)) {{$empleado->sanciones->fecha}} @endif">
