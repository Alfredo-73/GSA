    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title w-100 font-weight-bold text-center" style="color:darkblue">EMPLEADO:  @if(!empty($sancion->nombre)){{$sancion->nombre}}   {{$sancion->apellido}}@endif</h5>
            ...
            <div class="modal-body " style="margin-left:3rem">
                <div class="row">
                    ...
                    <div class="md-form mb-1" style="width:100%">
                         <input  style="width:10rem" type="text" id="orangeForm-pass" class="form-control" value="@if(!empty($sancion->empresa->razon_social)) {{$sancion->empresa->razon_social}} @endif">
                        ...
                        <input  style="width:7rem" type="text" id="orangeForm-pass" class="form-control" value="@if(!empty($sancion->capataz->nombre)) {{$sancion->capataz->nombre}} @endif">
                        ...
                        <div class="md-form mb-1" style="width:50%">
                        <i class="fas fa-dollar-sign prefix" style="color:darkblue"></i>
                        <input  style="width:7rem" type="text" id="orangeForm-pass" class="form-control" value="@if(!empty($sancion)) {{$sancion->fecha}} @endif">
                        ...
                        <input  style="width:7rem" type="text" id="orangeForm-pass" class="form-control" value="@if(!empty($sancion)){{$sancion->reincorporacion}} @endif">
