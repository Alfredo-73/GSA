                ...
                <div class="card-body">
                    <form method="POST" action="/modif_sancion/{{$sancion->id}}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dias" type="number" class="form-control" name="dias" value="{{ $sancion->dias }}" required autocomplete="dias">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fecha" type="date" class="form-control " name="fecha" value="{{ $sancion->fecha }}" required autocomplete="fecha">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="motivo" type="text" class="form-control" name="motivo" value="{{ $sancion->motivo }}" required autocomplete="motivo">
                        ...
                        <div class="form-group row shadow-textarea green-border-focus">
                           ...
                           <label for="observacion">{{ __('OBSERVACION') }}</label>
                             <textarea class="form-control z-depth-1" id="observacion" rows="3" name="observacion">{{ $sancion->observacion }}</textarea>
                            </div>
                        </div>
